...
//	withCard(t, false, false, nil, func(t *testing.T, c *TX) {
...
//}
//
//func withCard(t *testing.T, reset, long bool, extraFilter filter.Filter, cb func(t *testing.T, c *TX)) {
...
//	}
//
//	test.WithCard(t, flt, func(t *testing.T, c *iso.TX) {
...
//	withCard(t, false, true, nil, func(t *testing.T, c *TX) {
//		err := c.Reset()
